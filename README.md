...
Once you have that working, focus on parsing the YAML using the [gopkg.in/yaml.v3](https://godoc.org/gopkg.in/yaml.v3) package. _Note: You will need to `go get` this package if you don't have it already._
